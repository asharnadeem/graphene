...
Usage() {
    echo "Usage: testall.sh [options] [.gph files]"
...
Check() {
    ...
    Run "$CC" "-o" "${basename}.exe" "${basename}.s" "graphene.o" &&
...
if [ ! -f graphene.o ]
then
    echo "Could not find graphene.o"
    echo "Try \"make graphene.o\""
    exit 1
fi
